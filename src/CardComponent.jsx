...
function CardComponent() {
    return (
        // <div className='bg-reds-800 flex justify-between gap-8'>
        <div className='borders-2 flex flex-col p-8 gap-8 w-full sm:w-[360px] xl:w-full max-w-[420px] sshadow-md rounded-2xl bg-white '>
            <div className='font-bold text-lg xl:text-xl tracking-wider text-black'>GRAPHIC DESIGNING </div>
